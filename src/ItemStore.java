...
public class ItemStore {
    ...
    public static String[] fieldsToReviveAfterLoad = {
            ...
            "Album", "bands", "Band",
            "Band", "musicians", "Musician",
            "Band", "albums", "Album",
            "Band", "pastMusicians", "Musician",
            "Musician", "bands", "Band",
    ...
    public static ArrayList getList(String className) {
        return className.equals("Band") ? ItemStore.lists.bands :
                className.equals("Musician") ? ItemStore.lists.musicians :
                        className.equals("Album") ? ItemStore.lists.albums :
                                null;
    }
